...
const modules = [
  {
    ...
    title: "הבנת המורכבות",
    description:
      "למה רוב האנשים נתקעים כשמנסים לבנות אפליקציה, ואיך שוברים את המחסום הזה גם בלי רקע טכני. Vibe Engineering וארכיטקטורה: איך להפוך רעיון לתוכנית עבודה ישימה ולשרטט ארכיטקטורת פתרון נכונה.",
    topics: [
  ...
  {
    number: "02",
    title: "עבודה נכונה עם AI - ניסוח בקשות",
    description:
  ...
  {
    number: "04",
    title: "אבטיפוס למוצר עובד - העלאה לאוויר.",
